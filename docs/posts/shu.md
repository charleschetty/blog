...
[数值分析](https://item.jd.com/13071791.html)：上课用的是这本书英文版，中文版没找到pdf。这门课由于没有指定语言，可以自我发挥，前三次作业用了js，cpp和rust，第四次作业还没开始写
...
[斯坦福算法博弈论二十讲](https://item.jd.com/12624701.html)：这其实挺尴尬的，这按理说是一门经济学课，用的书又是计算机丛书系列教材，但是我还是放在数学基础课这个划分里了，虽然这本书证明写的相当胡。目前刚看完近似最优拍卖，由于没找到中文电子版，用的是图书馆的书，下周估计就必须得看完了。
